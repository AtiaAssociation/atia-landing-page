...
export function Footer({
  ...
  if (authMode) {
    return (
      <footer className="bg-gray-900 text-white py-4 text-center mt-8">
        <span>Authentification &copy; {new Date().getFullYear()} ATIA</span>
      </footer>
    );
  }
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              L'Association Tunisienne pour l'Intelligence Artificielle œuvre
              pour le développement et la promotion de l'IA en Tunisie.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300 text-sm">
                  ENIS, Campus Universitaire de la Manouba, CP 2010, La Manouba
                  - Tunis
                </span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a
                  href="mailto:contact@atia.org.tn"
                  className="text-gray-300 text-sm hover:text-primary transition-colors"
                >
                  contact@atia.org.tn
                </a>
