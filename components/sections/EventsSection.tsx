                      ...
                      <div className="relative z-10 p-8 md:p-12 h-full flex flex-col justify-between text-white">
                        <div>
                          {currentEvent.featured && (
                            <Badge className="bg-orange-500 hover:bg-orange-600 mb-4 text-sm px-3 py-1">
                              Événement Principal
                            </Badge>
                          )}
                    ...
                    <CardContent className="p-8 md:p-12">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        <motion.div
                          ...
                          whileTap={{ scale: 0.95 }}
                        >
                          <Button className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white px-8 py-4 text-lg font-semibold rounded-full shadow-lg">
